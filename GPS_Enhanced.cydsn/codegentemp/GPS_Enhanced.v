...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("b964ec5c-a437-4a9e-8f18-60b5934c6ae1/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("6510416666.66667"),
		  .is_direct(0),
...
module top ;
    ...
    defparam GPS_UART.HwTXEnSignal = 1;
    ...
    UART_v2_50_1 OUTPUT_UART (
        ...
        .tx_en(Net_25),
        .tx_interrupt(Net_26));
    defparam OUTPUT_UART.Address1 = 0;
    defparam OUTPUT_UART.Address2 = 0;
    defparam OUTPUT_UART.EnIntRXInterrupt = 0;
    defparam OUTPUT_UART.EnIntTXInterrupt = 0;
    defparam OUTPUT_UART.FlowControl = 0;
    defparam OUTPUT_UART.HalfDuplexEn = 0;
    defparam OUTPUT_UART.HwTXEnSignal = 1;
    defparam OUTPUT_UART.NumDataBits = 8;
    defparam OUTPUT_UART.NumStopBits = 1;
    defparam OUTPUT_UART.ParityType = 0;
    defparam OUTPUT_UART.RXEnable = 1;
    defparam OUTPUT_UART.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("3713e651-51fb-423e-9421-330258f5cae0"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7e5260d7-beaa-4d51-9dad-34b6a9e896ba"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
