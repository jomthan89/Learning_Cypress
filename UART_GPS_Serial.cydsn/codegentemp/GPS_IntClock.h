...
#define GPS_IntClock_SetDivider(clkDivider)         GPS_IntClock_SetDividerRegister(clkDivider, 1u)
#define GPS_IntClock_SetDividerValue(clkDivider)    GPS_IntClock_SetDividerRegister((clkDivider) - 1u, 1u)
...
#define GPS_IntClock_SetPhaseValue(clkPhase)        GPS_IntClock_SetPhaseRegister((clkPhase) + 1u)
#endif /* defined(GPS_IntClock__CFG3) */
