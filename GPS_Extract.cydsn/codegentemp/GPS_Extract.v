...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("8cefe22f-507e-4e9c-8eaa-df1e51a23e2f/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("13020833333.3333"),
		  .is_direct(0),
...
module top ;
    ...
    defparam GPS.EnIntRXInterrupt = 0;
	...
	cy_psoc3_pins_v1_10
		#(.id("2c1382ef-56d0-4e19-ae9a-84ce6272f78b"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7088f424-9cec-492d-a918-1d4c80e21258"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
