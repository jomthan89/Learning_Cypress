// ======================================================================
// GPS_ExtractV2.v generated from TopDesign.cysch
// 03/28/2023 at 17:42
...
module UART_v2_50_1 (
	...
	cy_clock_v1_0
		#(.id("d817bf86-14b3-49ad-bccd-870f7ca7f9e6/be0a0e37-ad17-42ca-b5a1-1a654d736358"),
		  .source_clock_id(""),
		  .divisor(0),
...
module top ;
    ...
    UART_v2_50_0 UART1 (
        ...
        .tx_en(Net_12),
        .tx_interrupt(Net_13));
    defparam UART1.Address1 = 0;
    defparam UART1.Address2 = 0;
    defparam UART1.EnIntRXInterrupt = 0;
    defparam UART1.EnIntTXInterrupt = 0;
    defparam UART1.FlowControl = 0;
    defparam UART1.HalfDuplexEn = 0;
    defparam UART1.HwTXEnSignal = 1;
    defparam UART1.NumDataBits = 8;
    defparam UART1.NumStopBits = 1;
    defparam UART1.ParityType = 0;
    defparam UART1.RXEnable = 1;
    defparam UART1.TXEnable = 1;
    ...
    UART_v2_50_1 UART2 (
        ...
        .tx_en(Net_25),
        .tx_interrupt(Net_26));
    defparam UART2.Address1 = 0;
    defparam UART2.Address2 = 0;
    defparam UART2.EnIntRXInterrupt = 0;
    defparam UART2.EnIntTXInterrupt = 0;
    defparam UART2.FlowControl = 0;
    defparam UART2.HalfDuplexEn = 0;
    defparam UART2.HwTXEnSignal = 1;
    defparam UART2.NumDataBits = 8;
    defparam UART2.NumStopBits = 1;
    defparam UART2.ParityType = 0;
    defparam UART2.RXEnable = 1;
    defparam UART2.TXEnable = 1;
	...
	cy_psoc3_pins_v1_10
		#(.id("f3c6c9de-42a1-4b4a-be89-0934d2326dbf"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("48d4e7fc-3c05-4a8a-87cf-a8a9b71b0cff"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	wire [0:0] tmpOE__PW_GPS_net;
	wire [0:0] tmpFB_0__PW_GPS_net;
	wire [0:0] tmpIO_0__PW_GPS_net;
	wire [0:0] tmpINTERRUPT_0__PW_GPS_net;
	electrical [0:0] tmpSIOVREF__PW_GPS_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		PW_GPS
		 (.oe(tmpOE__PW_GPS_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__PW_GPS_net[0:0]}),
		  .io({tmpIO_0__PW_GPS_net[0:0]}),
		  .siovref(tmpSIOVREF__PW_GPS_net),
		  .interrupt({tmpINTERRUPT_0__PW_GPS_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
