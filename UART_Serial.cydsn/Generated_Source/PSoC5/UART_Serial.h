...
#define UART_Serial_RX_INTERRUPT_ENABLED           (1u)
#define UART_Serial_TX_INTERRUPT_ENABLED           (0u)
#define UART_Serial_INTERNAL_CLOCK_USED            (0u)
...
#define UART_Serial_RX_BUFFER_SIZE                 (1600u)
...
extern uint8 UART_Serial_initVar;
    ...
    extern volatile uint16 UART_Serial_rxBufferRead;
    extern volatile uint16 UART_Serial_rxBufferWrite;
